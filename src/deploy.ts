...
const secretKeyUsers2 = getEnvVariable("WALLET_SECRET_KEYUser2");
...
const deployerAccount = await WalletClient.getAccountFromSecretKey(secretKeyUsers2);
    ...
    [
      {
        ...
        args: new Args().addString('MToken')
        .addString('MTS')
        .addU8(18)
        .addU256(1000000000n)
